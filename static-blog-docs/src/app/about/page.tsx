    ...
    <section className="mx-auto max-w-5xl space-y-16 py-8">
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <p className="leading-8 text-gray-600">
          ...
          and statically generates pages during the build process. This
          approach delivers excellent performance, improved SEO, and a clean
          separation between content and application code.
        </p>
      </section>
